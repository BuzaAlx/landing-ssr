...
import { IPortfolioProps } from "../../../types/components/index";

const Portfolio: React.FC<IPortfolioProps> = ({ projects }) => (
        ...
        {projects.map((p) => (
          <div key={p.id} className="porfolio__card">
            <figure className="portfolio__wrapper">
              ...
              <figcaption className="porfolio__card_name">{p.name}</figcaption>
